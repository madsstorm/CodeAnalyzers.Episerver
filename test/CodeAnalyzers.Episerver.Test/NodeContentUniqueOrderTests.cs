...
namespace CodeAnalyzers.Episerver.Test
{
    public class NodeContentUniqueOrderTests
    {
        ...
        public async Task DetectProductContentWithDuplicateOrder()
        {
            ...
            await Verify.VerifyAnalyzerAsync(test,
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(8, 22).WithArguments("NodeContent", "TypeName", "OtherType"),
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(13, 22).WithArguments("NodeContent", "OtherType", "TypeName"));
        }
    }
}
