...
namespace CodeAnalyzers.Episerver.Test
{
    public class BundleContentUniqueOrderTests
    {
        ...
        public async Task DetectProductContentWithDuplicateOrder()
        {
            ...
            await Verify.VerifyAnalyzerAsync(test,
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(8, 22).WithArguments("BundleContent", "TypeName", "OtherType"),
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(13, 22).WithArguments("BundleContent", "OtherType", "TypeName"));
        }
    }
}
