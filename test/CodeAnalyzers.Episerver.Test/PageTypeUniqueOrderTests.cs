...
namespace CodeAnalyzers.Episerver.Test
{
    public class PageTypeUniqueOrderOrderTests
    {
        ...
        public async Task DetectPageTypesWithDuplicateOrder()
        {
            ...
            await Verify.VerifyAnalyzerAsync(test,
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(7, 22).WithArguments("PageData", "TypeName", "OtherType"),
                Verify.Diagnostic(Descriptors.Epi2004ContentTypeShouldHaveUniqueOrder).WithLocation(12, 22).WithArguments("PageData", "OtherType", "TypeName"));
        }
    }
}
